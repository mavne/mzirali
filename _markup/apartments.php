...
<body class="inner-page apartments-page">
...
<main>
	...
	<section class="apartments">
		<div class="center_small">
			<div class="left">
				<h2>გადახდის პირობები</h2>

				<div class="content">
					<p><span class="number">0%</span></p>
					<p>შიდა 0% განვადება 2024 წლის ბოლომდე</p>
				</div>

				<div class="content">
					<p><span class="number">100%</span><span class="small">-ით</span></p>
					<p>გადახდის შემთხვევაში ექსკლუზიური პირობა კომპანიისგან</p>
				</div>
			</div>
			
			<div class="right">
				<div class="map-box">
					<div class="mapImage" id="mapImage" style="background-image: url('/_markup/assets/img/render.png');">
						<img src="/_markup/assets/img/render.png" class="map" usemap="#features" style="opacity: 0;" />
